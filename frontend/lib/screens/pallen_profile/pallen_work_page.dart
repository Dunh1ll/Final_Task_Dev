    ...
    return Column(children: [
      ...
      Container(
        ...
        child: Column(
          ...
          children: [
            // ── Page header ─────────────────────────────────────────
            ScrollReveal(child: const PallenEyebrowLabel('02 — WORK & PROJECTS')),
            ScrollReveal(
              delay: 0.1,
              child: Text(
            ...
            ScrollReveal(child: const PallenSubLabel('Work Immersion')),
...
Text(
  ...
  style: TextStyle(
            ...
            ScrollReveal(child: const PallenSubLabel('Work Activities')),
            const SizedBox(height: 20),
            ...
            const SizedBox(height: 52),
            ScrollReveal(child: const PallenSubLabel('Projects')),
            const SizedBox(height: 20),
...
Text(
  ...
  'the Visually Impaired',
            ...
            const SizedBox(height: 44),
            ScrollReveal(child: const PallenSubLabel('Project Deliverables')),
            const SizedBox(height: 20),
