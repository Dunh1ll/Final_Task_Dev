...
class MainProfileCardKarl extends StatefulWidget {
  ...
  @override
  State<MainProfileCardKarl> createState() => _MainProfileCardKarlState();
}
  ...
  Widget _nameBlock(double h) {
    ...
    return Column(
      ...
      children: [
        ...
        _infoRow(Icons.cake_outlined, 'August 25, 2004', h),
        SizedBox(height: h * 0.016),
        _infoRow(Icons.school_outlined, 'BS Information Systems', h),
        SizedBox(height: h * 0.016),
        _infoRow(Icons.location_on_outlined, 'Bay, Laguna', h),
      ],
    );
  }
